...
//   _czc = null;
// }
// _czc && _czc.push(["_setAutoPageview", false]);
export class Cnzz
{
  /**
   ...
   */
  public static trackEvent(category: string, action: string, label?: string, value?: number, nodeid?: string)
  {
    _czc && _czc.push(["_trackEvent", category, action, label, value, nodeid]);
  }
   ...
   */
  public static trackPageView(content_url: string, referer_url?: string)
  {
    _czc && _czc.push(["_trackPageview", content_url, referer_url || window.location.href.split('?')[0]]);
  }
